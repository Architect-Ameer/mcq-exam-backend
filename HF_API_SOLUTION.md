...
Your token: `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`

To verify:
```python
from huggingface_hub import HfApi

api = HfApi(token="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")
user = api.whoami()
...
client = InferenceClient(
    api_key="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"  # ← Use api_key not token
)
...
client = InferenceClient(
    api_key="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"
)
...
1. **Test Direct API:**
   ...
   client = InferenceClient(api_key="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")
